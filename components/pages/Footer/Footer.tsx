...
export const Footer = () => {
    return (
        <footer style={{backgroundColor:"#0b111e"}} className="mx-auto py-100 px-4 relative border-t border-border mt-12 pt-8 flex flex-wrap items-center justify-between">
            {/* Social icons */}
